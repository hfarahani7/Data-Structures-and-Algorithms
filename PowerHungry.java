//For google's foobar challenge. From set xs of integers return maximum product of any subset
//Constraints: 1 <= n <= 50, |xs[n]| <= 1000
//product must be returned as string due to possibility of very large outcomes 
